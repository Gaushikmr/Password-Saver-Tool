...
button = Button(root, text="Add", borderwidth=5, padx=50, pady=10, command=ClickAdd, fg="Black",
                bg="Yellow").grid(row=4, column=0)
button1 = Button(root, text="Show Passwords", borderwidth=5, padx=50, pady=10, command=readPasswords, fg="black",
                bg="Skyblue").grid(row=4, column=1)
